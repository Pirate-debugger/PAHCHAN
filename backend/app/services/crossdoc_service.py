...
def cross_validate_documents(
    ...
    """
    Compares two documents field-by-field with normalization.
    Returns match boolean and list of side-by-side discrepancies.
    """
    ...
    if name1 and name2 and name1 != name2:
        mismatches.append({
            ...
            "value2": name2,
            "severity": "critical",
            "description": f"Holder full name discrepancy: '{name1}' in {doc1_label} does not match '{name2}' in {doc2_label}."
        })
